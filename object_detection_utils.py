...
class ObjectDetectionUtils:
    ...
    def __init__(
        ...
        Args:
            ...
            label_font (str): Path to the font used for labeling.
                Defaults to "LiberationSans-Regular.ttf".
        """
    ...
    def draw_detections(
            ...
            scale_factor: float = 1) -> np.ndarray:
        """Draw detections on the image.

        Args:
            detections (dict): Detection results containing 'detection_boxes',
    ...
    def extract_detections(self, input_data: list, threshold: float = 0.5) -> dict:
        ...
        for i, detection in enumerate(input_data):
            ...
            # for yolov8 detection is a list of lists.
